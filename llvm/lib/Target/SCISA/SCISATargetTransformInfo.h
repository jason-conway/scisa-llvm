...
#ifndef LLVM_LIB_TARGET_SCISA_SCISATARGETTRANSFORMINFO_H
#define LLVM_LIB_TARGET_SCISA_SCISATARGETTRANSFORMINFO_H
...
class SCISATTIImpl : public BasicTTIImplBase<SCISATTIImpl> {
    typedef BasicTTIImplBase<SCISATTIImpl> BaseT;
    typedef TargetTransformInfo TTI;
    friend BaseT;

    const SCISASubtarget *ST;
    const SCISATargetLowering *TLI;

    const SCISASubtarget *getST() const
    {
        return ST;
    }
    const SCISATargetLowering *getTLI() const
    {
        return TLI;
    }

public:
    explicit SCISATTIImpl(const SCISATargetMachine *TM, const Function &F)
...
#endif // LLVM_LIB_TARGET_SCISA_SCISATARGETTRANSFORMINFO_H
